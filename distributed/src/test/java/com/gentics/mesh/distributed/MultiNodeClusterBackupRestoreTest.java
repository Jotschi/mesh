...
/**
 * Test how a backup/restore behaves with more than two nodes in a cluster.
 */
public class MultiNodeClusterBackupRestoreTest extends AbstractClusterTest {
	...
	public static MeshDockerServer serverC = new MeshDockerServer()
		.withClusterName("dockerCluster" + clusterPostFix)
		.withNodeName("nodeC")
		.withDataPathPostfix(randomToken())
		.withClearFolders();

	public static MeshDockerServer serverD = new MeshDockerServer()
		.withClusterName("dockerCluster" + clusterPostFix)
		.withNodeName("nodeD")
		.withDataPathPostfix(randomToken())
		.withClearFolders();
